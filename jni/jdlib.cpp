...
JNIEXPORT jlong JNICALL Java_io_metaloom_jdlib_Jdlib_getFaceDetectorHandler(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jlong JNICALL Java_io_metaloom_jdlib_Jdlib_getShapePredictorHandler(JNIEnv *env, jobject obj, jstring model_path)
{
...
JNIEXPORT jobject JNICALL Java_io_metaloom_jdlib_Jdlib_getFacialLandmarks(JNIEnv *env, jobject obj, jlong shapePredictorHandler, jlong faceDetectorHandler, jbyteArray imgdata, jint h, jint w)
{
...
JNIEXPORT jobject JNICALL Java_io_metaloom_jdlib_Jdlib_getFaceEmbeddings(JNIEnv *env, jobject obj, jlong faceEmbeddingHandler, jlong shapePredictorHandler, jlong faceDetectorHandler, jbyteArray imgdata, jint h, jint w)
{
